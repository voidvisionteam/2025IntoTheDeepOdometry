package org.firstinspires.ftc.teamcode.voidvision.lightsTester.Special;
...
@Autonomous(name = "redLeftAutoSpecialLights",group = "Autonomous")
public  class redLeftAutoSpecialLights extends Auto_Util {
