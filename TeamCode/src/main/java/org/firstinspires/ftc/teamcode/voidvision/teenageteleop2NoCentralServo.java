...
@TeleOp(name="NoCentralServo::teenageteleop2", group="Pushbot")
public class teenageteleop2NoCentralServo extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            robot.transitionServo.setPower(0.0);
