...
@Autonomous(name = "Full Send Framework",group = "Autonomous")
public  class FullSendFramework extends Auto_Util {
    ...
    public Action Park(Pose2d pose2d){
        return new ParallelAction(
                lift14.liftDown(),
                drive.actionBuilder(pose2d)
