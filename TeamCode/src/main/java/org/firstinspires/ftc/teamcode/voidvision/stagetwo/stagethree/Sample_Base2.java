...
public class Sample_Base2 extends Auto_Framework2 {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        Action NewSample1run = drive.actionBuilder(beginPose)
                ...
                .build();
        Action NewCollectSample2 = drive.actionBuilder(new Pose2d(7,38,(180/360d)*fullTurn))
                .strafeTo(new Vector2d (18,23.4))
                .strafeTo(new Vector2d (51,23.4))
                .strafeTo(new Vector2d (51,34.4))
                .strafeTo(new Vector2d (21,34.4))
                .build();
        Action NewScoreSample2 = drive.actionBuilder(new Pose2d(21,34.4,(180/360d)*fullTurn))
                .strafeTo(new Vector2d (8,38))//prep!!
                //.waitSeconds(2)
                .turn((-45/360d)*fullTurn)
                .strafeTo(new Vector2d (6,42))
                .build();
        Action NewCollectSample3 = drive.actionBuilder(new Pose2d(7,38,(180/360d)*fullTurn))
                .strafeTo(new Vector2d (18,23.4+9.5*(1)))
                .strafeTo(new Vector2d (51,23.4+9.5*(1)))
                .strafeTo(new Vector2d (51,34.4+9.5*(1)))
                .strafeTo(new Vector2d (21,34.4+9.5*(1)))
        ...
        waitForStart();
        Actions.runBlocking(
                new SequentialAction(StateRun)

        );
    }
    Action ScoreSampleWaitAction(boolean Xis6, boolean Yis42, boolean angleIs135){
        return new SequentialAction(drive.actionBuilder(new Pose2d(6,42,(135/360d)*fullTurn))
                .waitSeconds(0)
                .build());
    }
    Action PostSampleBackupAction(boolean Xis6, boolean Yis42, boolean angleIs135){
