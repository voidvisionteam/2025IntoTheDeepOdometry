 ...
 */
public class diagnostichwmap extends HardwareMapUtil {
    ...
    public void init(HardwareMap ahwMap) {
        ...
        range1Servo = HardwareInitServo("hippo1", .15); // Left range servo
        range2Servo = HardwareInitServo("hippo2", Finalrange - .15); // Right range servo
